...
public class restServlet extends HttpServlet {
    ...
    restClient productc;
    Product product;
    GenericType<Collection<Product>> generic;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<body>");
             ...
             productc = new restClient();
            generic = new GenericType<Collection<Product>>(){};
            productc.addProduct("1", "pname", "brandless");
//           productclient.removeProduct("4","2","2");
            res = productc.getAllproduct(Response.class);
            Collection<Product> product = res.readEntity(generic);
